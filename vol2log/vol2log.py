...
try:
	...
	parser.add_argument("-plugin", action='store', dest='plugin',
			    help="Enter Volatility Plugin", required=True, choices=["malfind", "connscan", "pslist", "netscan", "dlllist", "getsids", "userassist", "psscan", "ldrmodules", "psxview", "modscan", "apihooks", "svcscan"])
