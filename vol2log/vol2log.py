...
try:
	...
	parser.add_argument("-plugin", action='store', dest='plugin',
			    help="Enter Volatility Plugin", required=True, choices=["malfind", "connscan", "pslist", "netscan", "dlllist", "getsids", "userassist", "hashdump", "autoruns", "hivelist", "psscan", "handles", "ldrmodules", "psxview", "modscan", "apihooks", "cmdscan", "consoles", "svcscan", "filescan"])
